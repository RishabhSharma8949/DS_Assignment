...
/* Define the structure for each term of polynomial */
struct poly {
...
int main() {
    struct poly p1[10], p2[10], p3[10];  // declare arrays to hold polynomials
    int t1, t2, t3;  // t1, t2, t3 are number of terms in polynomials
